...
parser.add_argument('--neighbor_sample_size', type=int, default=4, help='the number of neighbors to be sample')
...
parser.add_argument('--batch_size', type=int, default=4098, help='batch size')
...
# parser.add_argument('--lr_kge', type=float, default=1e-2, help='learning rate of KGE task')
# parser.add_argument('--kge_interval', type=int, default=2, help='training interval of KGE task')
